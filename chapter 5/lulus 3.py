...
if(batas_bwh > nilai_bi) or (batas_ats < nilai_bi) or (batas_bwh > nilai_mat) or (batas_ats < nilai_mat) or (batas_bwh > nilai_ipa) or (batas_ats < nilai_ipa):
    ...
    print('         TIDAK LULUS     ')
    if(nilai_bi < minim_nilai):
        print('- NILAI BAHASA INDONESIA KURANG DARI 60')
    if(nilai_ipa < minim_nilai):
        print('- NILAI ILMU PENGETAHUAN ALAM KURANG DARI 60')
    if(nilai_mat < minim_nilai) and (nilai_mat < nilai_mtk):
        print('- NILAI MATEMATIKA KURANG DARI 71')
